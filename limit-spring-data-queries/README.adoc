...
== References
- https://docs.spring.io/spring-security/reference/5.6.3/servlet/authorization/expression-based.html#_method_security_expressions[Method Security Expressions]
- https://docs.spring.io/spring-security/reference/5.6.3/servlet/integrations/data.html[Spring Data & Spring Security Configuration]
