...
== Getting things done
* link:https://github.com/timtebeek/spring-security-samples/tree/main/limit-spring-data-queries#entities--repositories[PreAuthorize, PostAuthorize and configure] the application enabling the user to save and find preferences by id
