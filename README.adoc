...
. link:adding-spring-security/[Adding Spring Security]: Secure an existing application.
...
2. Verify the tests for adding-spring-security

  ./mvnw -B verify --file adding-spring-security/pom.xml

3. If you are new to Spring Security, start with link:adding-spring-security/README.adoc[Adding Spring Security]!

4. Once you have completed the basics, continue with any of the other modules.
