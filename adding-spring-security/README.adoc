...
These recordings come from Keycloak, with setup covered in the link:../spring-cloud-gateway-with-oidc-tokenrelay/README.adoc[Spring Cloud Gateway with OpenID Connect workshop].
