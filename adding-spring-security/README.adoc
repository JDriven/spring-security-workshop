...
We originally added four different types of tests which each use a full or partial Spring application context, to simulate what you might find in an existing application.
...
But don't worry, we will break these as soon as we enforce authorization.
