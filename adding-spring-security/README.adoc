...
- https://docs.spring.io/spring-security/reference/5.6.4/servlet/authorization/index.html[Authorization Chapter]
- https://docs.spring.io/spring-security/reference/5.6.4/servlet/authorization/method-security.html[Method Security]
- https://docs.spring.io/spring-security/reference/5.6.4/servlet/test/index.html[Testing Chapter]
