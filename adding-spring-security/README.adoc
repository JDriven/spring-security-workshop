...
You can see the application in this state in `leaveapp-initial`, along with the current set of application tests.
...
If you get stuck at any point, `leaveapp-complete` shows the application in a final form, with `src/main` and `src/test` updated to the above specification.
