...
5. On the `spring-cloud-gateway-client` client Credentials tab, `Regenerate Secret` and replace `<your secret> in link:../travel-gateway/src/main/resources/application.yml[`application.yml`] with generated secret.
